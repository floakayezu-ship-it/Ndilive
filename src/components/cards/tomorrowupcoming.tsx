...
export default function TomorrowEvents() {
    ...
    <div style={{ width: "100%" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ color: "#fff", fontSize: "18px", fontWeight: 700 }}>Tomorrow</span>
          <span style={{ color: "#e53935", fontSize: "8px" }}>●</span>
          <span style={{ color: "#888", fontSize: "13px" }}>May 25, 2025</span>
        </div>
        <button style={{
